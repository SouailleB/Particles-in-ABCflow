...
class quaternion{
 public:
  //Constructors---------------------------------------------------
  quaternion();
  quaternion(double p, double nx, double ny, double nz); //Set with an angle and an axis of rotation, automaticaly normalized
  quaternion(double p, point n);
  quaternion(const quaternion& q);

  //Methods-------------------------------------------------------
  void   set(int n, double x); //Set and get the actual components of the quaternion
  double get(int n);
